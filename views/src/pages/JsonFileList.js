...
const JsonDataList = () => {
  ...
  useEffect(() => {
    const fetchJsonData = async () => {
      ...
      try {
        const response = await fetch(`https://admin.postlii.com/api/json/all`, {
          headers: {
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '12px' }}>
            <button
              onClick={async () => {
                ...
                try {
                  const response = await fetch(`https://admin.postlii.com/api/json/${id}`, {
                    method: 'DELETE',
                    headers: {
  ...
  return (
    ...
    >
      ...
      <h2 style={{ color: "#ffffff", padding: "12px", textAlign: 'center', fontWeight:'700' }}>
        🧬 Uploaded JSON Data
      </h2>
